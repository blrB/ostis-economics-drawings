EconomicsBusListener = function (scene) {
    this.scene = scene;
};

EconomicsBusListener.prototype = {

    constructor: EconomicsBusListener,
    ...
    onMouseDownObject: function (obj) {
        if (!this.scene.bus_data.source && !obj.bus && !(obj instanceof Economics.ModelBus)) {
            ...
            if (obj instanceof Economics.ModelContour){
    ...
    finishCreation: function () {
        this.scene.commandManager.execute(new EconomicsCommandCreateBus(this.scene.bus_data.source, this.scene));
    }
