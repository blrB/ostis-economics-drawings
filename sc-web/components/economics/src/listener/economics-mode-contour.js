EconomicsContourListener = function(scene) {
    this.scene = scene;
};

EconomicsContourListener.prototype = {

    constructor: EconomicsContourListener,
    ...
    finishCreation: function () {
        this.scene.commandManager.execute(new EconomicsCommandCreateContour(this.scene));
    }
