EconomicsCommandCreateContour = function (scene) {
    this.scene = scene;
    this.contour = null;
};

EconomicsCommandCreateContour.prototype = {

    constructor: EconomicsCommandCreateContour,
    ...
    execute: function() {
        ...
        if (this.contour == null){
            ...
            this.contour = Economics.Creator.createCounter(polygon);
