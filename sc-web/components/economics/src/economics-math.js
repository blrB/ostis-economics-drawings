Economics.Vector2 = function (x, y) {
    this.x = x;
    this.y = y;
};

Economics.Vector2.prototype = {
    constructor: Economics.Vector2,
    ...
    clone: function () {
        return new Economics.Vector2(this.x, this.y);
    },
...
// --------------------
Economics.Vector3 = function (x, y, z) {
    this.x = x;
    this.y = y;
    this.z = z;
};

Economics.Vector3.prototype = {
    constructor: Economics.Vector3,
    ...
    clone: function () {
        return new Economics.Vector3(this.x, this.y, this.z);
    },
...
Economics.Math.distanceSquared = function (p1, p2) {
    var x = p1.x - p2.x,
        y = p1.y - p2.y;
 ...
 * @param point object with 'x' and 'y' fields, {Economics.Vector2} for example
 ...
 */
Economics.Algorithms.isPointInPolygon = function (point, vertecies) {
 ...
 * @param segStart the first point, object with 'x' and 'y' fields, {Economics.Vector2} for example
 * @param segEnd the second point, object with 'x' and 'y' fields, {Economics.Vector2} for example
 * @return {Array} intersection points
 */
Economics.Algorithms.polyclip = function (pin, segStart, segEnd) {
