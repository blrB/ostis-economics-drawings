...
append_js $sc_web_path/templates/components.html components/js/economics/economics.js
append_css $sc_web_path/templates/components.html components/css/economics.css
